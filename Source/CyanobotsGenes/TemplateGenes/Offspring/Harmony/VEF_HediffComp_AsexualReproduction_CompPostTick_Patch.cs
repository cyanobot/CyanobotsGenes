...
#else
    [HarmonyPatch(typeof(HediffComp_AsexualReproduction), nameof(HediffComp_AsexualReproduction.CompPostTickInterval))]
    public static class VEF_HediffComp_AsexualReproduction_CompPostTickInterval_Patch
    {

        public static MethodInfo m_ShouldRun = AccessTools.Method(
            typeof(VEF_HediffComp_AsexualReproduction_CompPostTickInterval_Patch),
            nameof(VEF_HediffComp_AsexualReproduction_CompPostTickInterval_Patch.ShouldRun));

        public static MethodInfo m_ApplyOffspringXenotype = AccessTools.Method(
            typeof(VEF_HediffComp_AsexualReproduction_CompPostTickInterval_Patch),
            nameof(VEF_HediffComp_AsexualReproduction_CompPostTickInterval_Patch.ApplyOffspringXenotype));
            ...
            for (int i = 0; i < instructions_array.Length; i++)
            {
                ...
                if (!finished)
                {
                    ...
                    else if (cur.LoadsField(AccessTools.Field(typeof(HediffCompProperties_AsexualReproduction), nameof(HediffCompProperties_AsexualReproduction.endogeneTransfer))))
                    {
                        ...
                        {
                            Log.Error("[Cyanobot's Genes]: VEF_HediffComp_AsexualReproduction_CompPostTickInterval_Patch transpiler unable to parse AnimalBehaviours.HediffComp_AsexualReproduction.CompPostTick");
                            finished = true;
                        }
                    }
